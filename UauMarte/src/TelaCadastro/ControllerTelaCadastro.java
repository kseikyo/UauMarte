...
import uaumarte.v1.ControllerTelaLogin;
...
public class ControllerTelaCadastro implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        //tf_CadastroLogin.getValidators().add(validateEmpty);
        ...
        //tf_CadastroTelefone.getValidators().add(validateEmpty);
        
        
        validateEmpty.setMessage("");
        
        /*tf_CadastroLogin.focusedProperty().addListener(new ChangeListener<Boolean>() {
        @Override
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldvalue, Boolean newValue) {
               if(!newValue) { 
                   tf_CadastroLogin.validate();
               }
            }
        });*/
